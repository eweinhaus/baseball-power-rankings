    ...
    return html.Div([
        ...
        html.Div(id="overview", className="section", children=[
            ...
            html.Div(className="content", children=[
                html.P("This Dash app is a live updating tool that predicts the playoff chances of each team in the Boston MABL. The app crawls the league website to get the results of all games played so far this season. It then uses these results to calculate the current standings and power rankings of each team. From there it creates a Monte Carlo simulation to simulate the remainder of the season a specified number of times. The app then calculates the playoff chances of each team based on the results of the simulations.", 
                       className="left", 
                ),
            ]),
            html.Div(
                [html.Img(src="/assets/BMBL_Logo.png", className="logo")], 
                className="right"),
        ]),
        ...
        html.Div(id="standings", className="section", children=[
            ...
            html.Div(className="content", children=[
                ...
                html.P("This page uses a webcrawler to grab outcome of each game from the league website and create live league standings, updated to the minute.", className="right")
            ])
        ]),
        ...
        html.Div(id="power-rankings", className="section", children=[
            ...
            html.Div(className="content", children=[
                ...
                html.P("The power rankungs page takes each team's performance thus far (Runs Scored, Runs Allowed, and Games Played) and applies Bill James' Pythagorean Win Probability formula to estimate each team's expected win percentage vs. a league average team. It then uses a derivative of Tangotigers win probability forumla, factors in each team's home field advantage and strength of schedule into pythagorean win percentage in order to get adjusted expected winning percentage, or 'Power Rank'", className="right")
            ])
        ]),
        ...
        html.Div(id="win-probability", className="section", children=[
            ...
            html.Div(className="content", children=[
                ...
                html.P("This page applies Tangotiger's win probability formula to each team's power rank in order to estimate the percentage chance any given home team beats any given away team in a potential matchup. It utilizes Dash callbacks in order to allow user to input any potential matchup and estimate outcome in real time.", className="right")
            ])
        ]),
